                    ...
                    <ul class="nav navbar-nav navbar-right">
                        <li class="dropdown">
                           ...
                           <ul class="dropdown-menu">
                            ...
                            <li>&nbsp;&nbsp;&nbsp;&nbsp;</li>
                            <!--<li><a href="#careerpath">CAREER PATH</a></li>-->
                            <li><a href="#pricing" class="btn link-btn">PRICING</a></li>
                            <!--<li><a href="#contact">CONTACT</a></li>-->
                            <li><a href="signup.php" class="btn link-btn" role="button">SIGN UP</a></li>
                            <li><a href="login.php" class="btn link-btn-wht" role="button">LOGIN</a></li>
<!--
                            <li>
